...
-(void)fileCopyOperationWillStart:(FileCopyOperation *)fileCopyOperation {
    ...
    [self.delegate respondsToSelector:@selector(queueOperationWillStart:)] ? [self.delegate queueOperationWillStart:fileCopyOperation] : nil;
}
...
-(void)fileCopyOperationDidFinished:(FileCopyOperation *)fileCopyOperation {
    ...
    [self.delegate respondsToSelector:@selector(queueOperationDidFinished:)] ? [self.delegate queueOperationDidFinished:fileCopyOperation] : nil;
}

- (void)fileCopyOperationStatusUpdate:(FileCopyOperation *)fileCopyOperation {
    [self.delegate respondsToSelector:@selector(queueOperationStatusUpdate:)] ? [self.delegate queueOperationStatusUpdate:fileCopyOperation] : nil;
}
...
-(NSView *)tableView:(NSTableView *)tableView viewForTableColumn:(NSTableColumn *)tableColumn row:(NSInteger)row {
    ...
    [cell.fileName setStringValue:[NSString stringWithFormat:@"Copying \"%@\" to %@",opr.fName, opr.dstURL]];
